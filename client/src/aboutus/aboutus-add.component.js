...
export default class AboutUsAdd extends Component {
  constructor(props) {
    super(props);
    ...
    this.newAboutUs = this.newAboutUs.bind(this);
...
handleCreate(e) {
  ...
  // saveAboutUs() {
    ...
    if (this.checkBtn.context._errors.length === 0) {  
      ...
      AboutUsDataService.create(data)
      .then(response => {
        this.setState({
          id: response.data.id,
        ...
        {this.state.submitted ? (
          <div>
            ...
            <p><button
                ...
                onClick={this.newAboutUs}>
                Add another About Us
              </button></p>
              <p><button
                className="submit-button">
                <Link to={"/aboutus"}>
          ...
          <Form onSubmit={this.handleCreate}
            ...
            <p><button
                className="submit-button"
                onClick={this.saveAboutUs}>
                Add About Us </button></p>
