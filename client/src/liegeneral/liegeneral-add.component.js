...
export default class LieGeneralAdd extends Component {
  constructor(props) {
    super(props);
    ...
    this.newLieGeneral = this.newLieGeneral.bind(this);
...
handleCreate(e) {
  ...
  // saveLieGeneral() {
    ...
    if (this.checkBtn.context._errors.length === 0) {  
      ...
      LieGeneralDataService.create(data)
      .then(response => {
        this.setState({
          id: response.data.id,
        ...
        {this.state.submitted ? (
          <div>
            ...
            <p><button
                ...
                onClick={this.newLieGeneral}>
                Add another General Lie
              </button></p>
              <p><button
                className="submit-button">
                <Link to={"/liesgeneral"}>
          ...
          <Form onSubmit={this.handleCreate}
            ...
            <p><button
                className="submit-button"
                onClick={this.saveLieGeneral}>
                Add General Lie </button></p>
