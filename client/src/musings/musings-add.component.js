...
export default class MusingsAdd extends Component {
  constructor(props) {
    super(props);
    ...
    this.newMusings = this.newMusings.bind(this);
...
handleCreate(e) {
  ...
  // saveMusings() {
    ...
    if (this.checkBtn.context._errors.length === 0) {  
      ...
      MusingsDataService.create(data)
      .then(response => {
        this.setState({
          id: response.data.id,
      ...
      <div className="submit-form">
        {this.state.submitted ? (
          ...
          <Form onSubmit={this.handleCreate}
            ...
            <p><button
                className="submit-button"
                onClick={this.saveMusings}>
                Add Musings </button></p>
